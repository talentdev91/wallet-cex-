...
function OcoRes(props: any) {
  const classes = useStyles()
  const loginSate = false
    ...
    <>
      <Grid container className={classes.orderContainer}>
        <Grid item xs={12} className={classes.orderContainer}>
          <form
            onSubmit={() => {
              props.select === 0 ? onBuySubmit : onSellSubmit
            }}
          >
            ...
            <div className={classes.inputSide}>
              ...
              <input onChange={handleChange('ocoPrice')} type="number" className={classes.input} step="any" />
            ...
            <div className={classes.inputSide}>
              ...
              <input onChange={handleChange('ocoStop')} type="number" className={classes.input} step="any" />
              <Typography variant="body2" className={classes.fontColor2}>
                {coin1}
              </Typography>
            </div>
            <div className={classes.inputSide}>
              ...
              <input onChange={handleChange('ocoLimit')} type="number" className={classes.input} step="any" />
              <Typography variant="body2" className={classes.fontColor2}>
                {coin1}
              </Typography>
            </div>
            <div className={classes.inputSide}>
              ...
              <input onChange={handleChange('ocoAmount')} type="number" className={classes.input} step="any" />
              <Typography variant="body2" className={classes.fontColor2}>
                {coin2}
              </Typography>
            </div>

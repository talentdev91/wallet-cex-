...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    ...
    mainTitle: {
      ...
      marginBottom: '20px',
      color: '#e5ecf3',
      // `${localStorage.appTheme === "darkTheme" ? "#e5ecf3" : "#4a4f55"}`,
    },
    titleDescription: {
...
export const StyledVerticalTab = withStyles((theme: Theme) => ({
  root: {
    ...
    color: theme.palette.primary.contrastText,
    '&:hover': {
      backgroundColor: '#422d1d',
      //   `${
      //   localStorage.appTheme === "darkTheme" ? "#422d1d" : "#fde0cb"
      // }`,
    },
    '&$selected': {
      color: 'white',
      backgroundColor: '#EF802F',
      //   `${
      //   localStorage.appTheme === "darkTheme" ? "#EF802F" : "#EF802F"
      // }`,
    },
    '&:focus': {},
  },

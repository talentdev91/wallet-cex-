...
function VerificationChangeModal({ handleClose, state }: VerificationChangeModalProps) {
        ...
        <Grid item md={12} sm={12} xs={12}>
          <div>
                  ...
                  <Grid item md={12} xs={12} sm={12}>
                    <div className={classes.EmailAddressVerificationChangeModalDialogContentCard}>
                      <Typography className={classes.EmailAddressVerificationChangeModalDialogContentCardTitle}>
                        Are you sure you want to change {state.type === 'phone-change' ? 'phone' : 'email'}{' '}
                        verification?
                      </Typography>
                      <ul>
            ...
            <Grid container spacing={1}>
              ...
              <Grid item md={6} sm={6} xs={6}>
                <Link
                  to={state.type === 'phone-change' ? '/my/change-sms-authenticator' : '/my/change-email-authenticator'}
